...
namespace RPG.Combat
{
    ...
    public class Weapon : ScriptableObject
    {
        ...
        public void LaunchProjectile(Transform LHand, Transform RHand, Health target, GameObject instigator) 
        {
            Projectile proj_instance = Instantiate(projectile, GetTransform(LHand, RHand).position, Quaternion.identity);
            proj_instance.SetTarget(instigator,target, WeaponDamage);
        }
